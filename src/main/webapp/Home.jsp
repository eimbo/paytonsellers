...
<div class="main">
	...
	<article class="featured" >
		<div class="featuredtitle">Best Sellers in Literature & Fiction</div>
			<c:forEach items="${litAndFic }" var="book">
	...
	<article class="featured">
		<div class="featuredtitle">Best Sellers in Sci-Fi & Fantasy</div>
			<c:forEach items="${sciFi}" var="book">
				<a class="book" href="${pageContext.request.contextPath}/view-book/${book.book_id}" />
					<img src="http://localhost:8080/paytonsellersbooks/img/${book.book_img}" /><br/>
					<span class="booktitle">${book.book_title }</span><br/>
					${book.book_author_first }	${book.book_author_last }<br/>
	...
	<article class="featured">
		<div class="featuredtitle">All Best Sellers</div>
